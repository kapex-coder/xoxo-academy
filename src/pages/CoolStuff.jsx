...
const CoolStuff = () => {
  return (
    <div id="cool-stuff">
      <h2 className="font-spartan font-bold px-8 py-4 text-4xl md:text-5xl xl:text-6xl max-w-screen-md mx-auto text-center text-[#6711a4]">
      ...
      <p className="px-8 py-6 text-center text-[#6711a4] lg:text-lg max-w-screen-sm mx-auto">
