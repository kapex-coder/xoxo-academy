...
const Goals = () => {
  return (
    <Section
      ...
      containerClassName="relative overflow-hidden md:max-w-screen-md h-full text-white md:flex md:items-end md:gap-8 pt-32 pb-24 md:py-20 lg:py-24"
      isSectionFooter>
      <h2 className="text-4xl max-md:mb-4 md:text-5xl font-bold max-w-sm font-spartan">
